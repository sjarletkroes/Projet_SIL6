...
{
  private static String  _id = "IDL:tier2_Corba/Joueur:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[2] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (tier2_Corba.JoueurHelper.id (), "Joueur", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    tier2_Corba.Joueur value = new tier2_Corba.Joueur ();
    value.login = istream.read_string ();
    value.pass = istream.read_string ();
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, tier2_Corba.Joueur value)
  {
    ...
    ostream.write_string (value.pass);
